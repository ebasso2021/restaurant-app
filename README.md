...
| 2 · Cocina e inventario | Tabla de stock sin columnas de costo (costo y valor están en el módulo 3, desde el Kardex); piezas por paquete bajo el nombre del artículo. Stock con **Alerta** y **Cantidad máxima**, botón **Agregar item**, cuadro y botón **+ Stock** (suma a lo existente), orden de compra automática, predicción de demanda (día y hora) con ajuste por IA, registro de merma. Stock en **g, kg, mL, L o unidades**; el costo es **siempre por kg, por L o por unidad** con **2 decimales** (y se muestra por g/mL). **Valor del stock = stock convertido a kg/L × costo** (4.500 g a CA$8,50/kg = CA$38,25). Las **piezas** se compran por **paquete** y se costean por unidad: **costo unitario = precio del paquete ÷ piezas del paquete** (caja de 30 huevos a CA$9,00 = CA$0,30 por huevo) y valor = unidades × costo unitario; 1 si se compran sueltas), valor = piezas ÷ N × costo (30 huevos a CA$4,20 el paquete de 12 = CA$10,50); **costo promedio ponderado** en cada compra; el botón **📒** de cada artículo abre su Kardex en el módulo 3. |
| 3 · Compras, ventas, costos y análisis | Cinco submenús: **🛒 Compras** (registrar compra con fecha, cantidad o paquetes, costo, proveedor, lote, caducidad y factura → entrada en el Kardex con **costo promedio ponderado**; lista de compras por periodo y proveedor con botón **✏ Editar** (al guardar se recalcula todo el Kardex de ese artículo en orden de fecha —saldos, costo promedio ponderado, valor y costo de las salidas posteriores— y se actualiza el inventario); tabla **Inventario = totales del Kardex** por ingrediente y botón **Recalcular inventario desde el Kardex**) · **Ventas** · **Costos** · **📒 Kardex** con las columnas Artículo · Costo por kg / L / paquete · Por g / mL / und · Valor del stock · Fecha de movimiento · Tipo (entrada / salida) · Cantidad · Costo unitario · Saldo actualizado · Proveedor · Lote · Caducidad (lotes vencidos en rojo, por vencer en 7 días en ámbar), formulario **Registrar movimiento**, botón **Reiniciar Kardex** (borra todo y crea una fila inicial por artículo con el stock y costo de Cocina e inventario; en la hoja: menú Taste of Peru → Reiniciar Kardex) y CSV. Las ventas cobradas en facturación son salidas del Kardex y bajan el inventario; en la web se guarda en la pestaña **Kardex** de la hoja de Google · **Costos** (costo por vaso, valor del stock y costos operativos) · **Ventas** (registro, KPIs, gráfico y tabla) · **Análisis y proyección** (KPIs, proyección de 7 días y análisis con IA). Registro de ventas, costo por vaso, ingresos, márgenes, gráfico diario, bebidas más rentables / "se vende bien, margen bajo", proyección de 7 días, análisis con IA. **Costos operativos** (personal con calculadora, alquiler, electricidad, impuestos, seguros, licencias y permisos anuales, mantenimiento de equipos, otros y costos propios; por semana/mes/año) → utilidad neta y punto de equilibrio (vasos al día). |
...
| 2 · Kitchen & inventory | Stock table without cost columns (cost and value are in module 3, from the Kardex); pieces per package under the item name. Stock with **Alert** and **Maximum quantity**, **Add item** button, **+ Stock** box and button (adds to existing), automatic purchase order, demand forecast (day and hour) with AI adjustment, waste log. Stock in **g, kg, mL, L or pieces**; the cost is **always per kg, per L or per piece** with **2 decimals** (also shown per g/mL). **Stock value = stock converted to kg/L × cost** (4,500 g at CA$8.50/kg = CA$38.25). **Pieces** are bought by the **package** and costed per piece: **unit cost = package price ÷ pieces in the package** (a box of 30 eggs at CA$9.00 = CA$0.30 per egg) and value = pieces × unit cost; 1 if bought one by one), value = pieces ÷ N × cost (30 eggs at CA$4.20 per pack of 12 = CA$10.50); **weighted average cost** on each purchase; each item's **📒** button opens its Kardex in module 3. |
| 3 · Purchases, sales, costs & analytics | Five sub-tabs: **🛒 Purchases** (register a purchase with date, quantity or packages, cost, supplier, lot, expiry and invoice → a Kardex entry at **weighted average cost**; purchases by period and supplier with an **✏ Edit** button (saving recalculates that item's whole Kardex in date order — balances, weighted average cost, value and the cost of later exits — and updates the inventory); **Inventory = Kardex totals** table per ingredient and a **Rebuild inventory from the Kardex** button) · **Sales** · **Costs** · **📒 Kardex** with the columns Item · Cost per kg / L / package · Per g / mL / piece · Stock value · Movement date · Type (in / out) · Quantity · Unit cost · Updated balance · Supplier · Lot · Expiry (expired lots in red, expiring within 7 days in amber), a **Register movement** form, a **Restart Kardex** button (erases everything and writes one opening row per item with the stock and cost of Kitchen & inventory; in the Sheet: menu Taste of Peru → Reiniciar Kardex) and CSV. Sales charged in billing are Kardex exits and lower the inventory; on the website it is saved in the **Kardex** tab of the Google Sheet · **Costs** (cost per cup, stock value and operating costs) · **Sales** (log, KPIs, chart and table) · **Analysis & projection** (KPIs, 7-day projection and AI analysis). Sales log, cost per cup, revenue, margins, daily chart, most profitable / "sells well, low margin" drinks, 7-day projection, AI analysis. **Operating costs** (staff with calculator, rent, electricity, taxes, insurance, annual licences and permits, equipment maintenance, other and your own costs; per week/month/year) → net profit and break-even (cups per day). |
